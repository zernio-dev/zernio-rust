...
**photos** | Option<[**Vec<models::ListInboxReviews200ResponseDataInnerPhotosInner>**](ListInboxReviews200ResponseDataInnerPhotosInner.md)> | Photos attached to the review. Google Business only; always an empty array for other platforms. | [optional]
