...
**event** | **Event** |  (enum: referral.received) | 
**referral** | [**models::WebhookPayloadReferralReferral**](WebhookPayloadReferralReferral.md) |  | 
**sender** | [**models::WebhookPayloadReferralSender**](WebhookPayloadReferralSender.md) |  | 
