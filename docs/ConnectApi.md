...
------------- | ------------- | ------------- | ------------- | -------------
**account_id** | **String** | A source connected Google Business Profile account whose OAuth grant is reused. | [required] |
...
> complete_meta_ads_business_login(state, code, error)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**state** | **String** | Authenticated state from the initial connectAds response. | [required] |
**code** | Option<**String**> | Single-use authorization code returned by Meta. |  |
**error** | Option<**String**> | Meta authorization error when the user declines the dialog. |  |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**complete_whats_app_phone_selection_request** | [**CompleteWhatsAppPhoneSelectionRequest**](CompleteWhatsAppPhoneSelectionRequest.md) |  | [required] |
**x_connect_token** | Option<**String**> | Alternative auth for API users' end customers |  |

### Return type

[**models::CompleteWhatsAppPhoneSelection200Response**](completeWhatsAppPhoneSelection_200_response.md)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**configure_tik_tok_ads_brand_identity_request** | [**ConfigureTikTokAdsBrandIdentityRequest**](ConfigureTikTokAdsBrandIdentityRequest.md) |  | [required] |

### Return type

[**models::ConfigureTikTokAdsBrandIdentity200Response**](configureTikTokAdsBrandIdentity_200_response.md)
...
> models::ConnectAds200Response connect_ads(platform, profile_id, login_mode, permission_level, page_id, account_id, redirect_url, headless, force, ad_account_id, ad_account_ids)
...
> models::ConnectWhatsAppEmbeddedSignup200Response connect_whats_app_embedded_signup(connect_whats_app_embedded_signup_request, x_connect_token)
...
**x_connect_token** | Option<**String**> | Connect token issued by the hosted signup flow, accepted instead of an API key. |  |

### Return type

[**models::ConnectWhatsAppEmbeddedSignup200Response**](connectWhatsAppEmbeddedSignup_200_response.md)
...
> models::ConnectWordPressWithApplicationPassword200Response connect_word_press_with_application_password(connect_word_press_with_application_password_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**connect_word_press_with_application_password_request** | [**ConnectWordPressWithApplicationPasswordRequest**](ConnectWordPressWithApplicationPasswordRequest.md) |  | [required] |

### Return type

[**models::ConnectWordPressWithApplicationPassword200Response**](connectWordPressWithApplicationPassword_200_response.md)
...
> models::GetConnectUrl200Response get_connect_url(platform, profile_id, redirect_url, headless, login_method, onboarding, signup, brand_name, primary_color, language)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**platform** | **String** | Social media platform to connect. `snapchat` is a closed beta with no public release date: it returns 403 `PLATFORM_BETA_RESTRICTED` until the account is approved. | [required] |
...
> models::GetPageWebhookSubscription200Response get_page_webhook_subscription(account_id)
...
[**models::GetPageWebhookSubscription200Response**](getPageWebhookSubscription_200_response.md)
...
**redirect_url** | Option<**String**> | Your custom redirect URL after connection completes. MUST be an absolute http(s) URL or a custom app scheme for mobile deeplinks (e.g. myapp://callback); a relative path is rejected with 400 INVALID_REDIRECT_URL. On failure an `error` query param is appended. |  |
...
> models::GetSubredditRules200Response get_subreddit_rules(account_id, subreddit)
Get subreddit rules
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**account_id** | **String** | The ID of the Reddit account | [required] |
**subreddit** | **String** | Subreddit name (without the \"r/\" prefix) | [required] |

### Return type

[**models::GetSubredditRules200Response**](getSubredditRules_200_response.md)
...
> models::GetWhatsAppSdkConfig200Response get_whats_app_sdk_config(x_connect_token)
...
> models::GetWordPressAuthUrl200Response get_word_press_auth_url(profile_id, redirect_url)
...
------------- | ------------- | ------------- | ------------- | -------------
**profile_id** | **String** | Your Zernio profile ID (get from /v1/profiles). | [required] |
**redirect_url** | Option<**String**> | Custom redirect after connection. Must be an absolute http(s) URL or custom app scheme such as `myapp://callback`; relative and unsafe URLs return 400. |  |

### Return type

[**models::GetWordPressAuthUrl200Response**](getWordPressAuthUrl_200_response.md)
...
[**models::GetYoutubePlaylists200Response**](getYoutubePlaylists_200_response.md)
...
> models::ListFacebookPages200Response list_facebook_pages(profile_id, temp_token, selection_token)
List Facebook pages
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**profile_id** | Option<**String**> | Profile ID from your classic connection flow. Required with tempToken. |  |
**temp_token** | Option<**String**> | Temporary Facebook access token from the classic OAuth callback. Required with profileId. |  |
**selection_token** | Option<**String**> | Encrypted dashboard business-login grant. Send alone instead of profileId and tempToken. Expires after ten minutes. |  |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**profile_id** | **String** | The Zernio profile ID from the headless redirect | [required] |
**temp_token** | **String** | The temporary access token from the headless redirect | [required] |
**x_connect_token** | Option<**String**> | Alternative auth for API users' end customers (used when the bearer token is scoped to a different user) |  |

### Return type

[**models::ListWhatsAppPhoneNumbers200Response**](listWhatsAppPhoneNumbers_200_response.md)
...
> models::ResyncPageWebhookSubscription200Response resync_page_webhook_subscription(account_id)
...
[**models::ResyncPageWebhookSubscription200Response**](resyncPageWebhookSubscription_200_response.md)
...
> models::UpdateYoutubeDefaultPlaylist200Response set_reddit_post_flair(account_id, set_reddit_post_flair_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**account_id** | **String** | The ID of the Reddit account that owns the post | [required] |
**set_reddit_post_flair_request** | [**SetRedditPostFlairRequest**](SetRedditPostFlairRequest.md) |  | [required] |
...
> models::UpdateYoutubeDefaultPlaylist200Response update_reddit_subreddits(account_id, update_reddit_subreddits_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**account_id** | **String** |  | [required] |
**update_youtube_default_playlist_request** | [**UpdateYoutubeDefaultPlaylistRequest**](UpdateYoutubeDefaultPlaylistRequest.md) |  | [required] |
...
> models::UpdateYoutubeDefaultPlaylist200Response vote_reddit_thing(account_id, vote_reddit_thing_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**account_id** | **String** | The ID of the Reddit account casting the vote | [required] |
**vote_reddit_thing_request** | [**VoteRedditThingRequest**](VoteRedditThingRequest.md) |  | [required] |
