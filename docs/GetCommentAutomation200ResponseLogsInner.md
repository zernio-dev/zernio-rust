...
**status** | Option<**Status**> | DM outcome. 'gated' = the follow-gate confirmation DM went out and we are waiting for the tap; it flips to 'sent' or 'skipped' when they tap. (enum: sent, failed, skipped, gated) | [optional]
