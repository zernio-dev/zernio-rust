...
**components** | Option<[**Vec<models::WhatsAppTemplateComponent>**](WhatsAppTemplateComponent.md)> | Template components (HEADER, BODY, FOOTER, BUTTONS). Required for custom templates, omit when using library_template_name. | [optional]
