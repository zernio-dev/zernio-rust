...
**required** | Option<**bool**> | Whether tiktokSettings.allow_comment must be supplied when creating a post. Always true, because TikTok forbids defaulting it. | [optional]
