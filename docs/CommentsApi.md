...
**comment_id** | Option<**String**> | (Facebook, Instagram, Reddit and TikTok) Get replies to a specific comment. On Facebook and Instagram, the requested comment is returned in the top-level `comment` field and comments[] holds its replies. |  |
...
**min_comments** | Option<**i32**> | Minimum comment count, applied to each page after pagination |  |
