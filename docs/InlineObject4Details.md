...
**verification_amount_cents** | Option<**i32**> | One-time card verification charge in USD cents, credited to usage. Only set when reason=card_verification_required. | [optional]
