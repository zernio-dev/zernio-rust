...
**reply_count** | Option<**i32**> | The platform's own reply count, which includes hidden and deleted replies. Can exceed replies[].length even when repliesHasMore is false or absent. | [optional]
...
**can_like** | Option<**bool**> | Whether this comment can be liked (Facebook, X, Bluesky, Reddit, LinkedIn) | [optional]
**is_hidden** | Option<**bool**> | Whether the comment is currently hidden. On Instagram accounts connected through Facebook Login, Meta leaves hidden comments (and their replies) out of the list entirely, so they never appear with isHidden true; Instagram Login accounts and Facebook Pages return them with isHidden true. | [optional]
