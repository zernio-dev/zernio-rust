...
**started_watching** | Option<**i32**> | Viewers who started watching in this segment. 0 when YouTube has no segment-level data for the video. | [optional]
**stopped_watching** | Option<**i32**> | Viewers who stopped watching in this segment. 0 when YouTube has no segment-level data for the video. | [optional]
