...
------------ | ------------- | ------------- | -------------
**publisher_platforms** | Option<**Vec<PublisherPlatforms>**> | Top-level platforms to deliver on. A position field below is only honoured when its parent platform is included here. (enum: facebook, instagram, threads, messenger, audience_network) | [optional]
