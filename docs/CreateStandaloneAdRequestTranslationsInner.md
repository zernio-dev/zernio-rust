...
**headline** | Option<**String**> | Headline for this language. Inherits the top-level `headline` when omitted. | [optional]
**body** | Option<**String**> | Primary text for this language. Inherits the top-level `body` when omitted. | [optional]
**description** | Option<**String**> | Link description for this language. Inherits the top-level `description` when omitted. | [optional]
