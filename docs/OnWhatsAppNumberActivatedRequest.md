...
**event** | Option<**Event**> |  (enum: whatsapp.number.activated) | [optional]
...
**number** | Option<[**models::OnWhatsAppNumberActivatedRequestNumber**](OnWhatsAppNumberActivatedRequestNumber.md)> |  | [optional]
