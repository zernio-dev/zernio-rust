...
------------ | ------------- | ------------- | -------------
**_id** | **String** |  | 
**platform** | **Platform** |  (enum: tiktok, instagram, facebook, youtube, linkedin, twitter, threads, pinterest, reddit, bluesky, googlebusiness, telegram, snapchat, discord, slack, whatsapp, shopify, wordpress, linkedinads, metaads, pinterestads, tiktokads, xads, googleads, openaiads, sms, phone, rcs) | 
**profile_id** | [**models::SocialAccountProfileId**](SocialAccountProfileId.md) |  | 
...
**parent_account_id** | Option<**String**> | Reference to the parent posting SocialAccount. Set for ads accounts that share or derive from a posting account's OAuth token. null for standalone ads (Google Ads) and all posting accounts. Meta ads business-login accounts also have no parent.  | [optional]
**enabled** | Option<**bool**> | Whether the user explicitly activated this account. false means the account was created as a side effect (e.g., posting account auto-created when user connected ads first). Such accounts are hidden from this list, cannot be posted to (`ACCOUNT_NOT_ENABLED_FOR_POSTING`), and are not billed as connected accounts.  | [optional]
