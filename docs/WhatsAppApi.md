...
> models::BlockWhatsAppUsers200Response block_whats_app_users(block_whats_app_users_request)
Block users
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**block_whats_app_users_request** | [**BlockWhatsAppUsersRequest**](BlockWhatsAppUsersRequest.md) |  | [required] |

### Return type

[**models::BlockWhatsAppUsers200Response**](blockWhatsAppUsers_200_response.md)
...
> models::UpdateYoutubeDefaultPlaylist200Response delete_whatsapp_business_username(delete_whatsapp_business_username_request)
...
> models::GetWhatsAppBlockStatus200Response get_whats_app_block_status(account_id, user)
...
**user** | **String** | Consumer wa_id or E.164 phone (leading + optional) | [required] |

### Return type

[**models::GetWhatsAppBlockStatus200Response**](getWhatsAppBlockStatus_200_response.md)
...
> models::GetWhatsAppBlockedUsers200Response get_whats_app_blocked_users(account_id, limit, after)
List blocked users
...
[**models::GetWhatsAppBlockedUsers200Response**](getWhatsAppBlockedUsers_200_response.md)
...
> models::GetWhatsappBusinessUsername200Response get_whatsapp_business_username(account_id)
...
[**models::GetWhatsappBusinessUsername200Response**](getWhatsappBusinessUsername_200_response.md)
...
> models::GetWhatsappBusinessUsernameSuggestions200Response get_whatsapp_business_username_suggestions(account_id)
...
[**models::GetWhatsappBusinessUsernameSuggestions200Response**](getWhatsappBusinessUsernameSuggestions_200_response.md)
...
> models::RegisterWhatsAppNumber200Response register_whats_app_number(account_id, register_whats_app_number_request)
...
**register_whats_app_number_request** | Option<[**RegisterWhatsAppNumberRequest**](RegisterWhatsAppNumberRequest.md)> |  |  |

### Return type

[**models::RegisterWhatsAppNumber200Response**](registerWhatsAppNumber_200_response.md)
...
> models::SetWhatsappBusinessUsername200Response set_whatsapp_business_username(set_whatsapp_business_username_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**set_whatsapp_business_username_request** | [**SetWhatsappBusinessUsernameRequest**](SetWhatsappBusinessUsernameRequest.md) |  | [required] |

### Return type

[**models::SetWhatsappBusinessUsername200Response**](setWhatsappBusinessUsername_200_response.md)
...
> models::UnblockWhatsAppUsers200Response unblock_whats_app_users(unblock_whats_app_users_request)
Unblock users
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**unblock_whats_app_users_request** | [**UnblockWhatsAppUsersRequest**](UnblockWhatsAppUsersRequest.md) |  | [required] |

### Return type

[**models::UnblockWhatsAppUsers200Response**](unblockWhatsAppUsers_200_response.md)
