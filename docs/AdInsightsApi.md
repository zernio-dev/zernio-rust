...
> models::GetAdsSearchTerms200Response get_ads_search_terms(account_id, ad_account_id, customer_id, from_date, to_date, campaign_id, ad_set_id, ad_group_id, page_token)
...
**ad_set_id** | Option<**String**> | Platform ad set ID (Google ad group). Same value as adSetId on listAdKeywords and /ad-sets/{adSetId}/assets. |  |
**ad_group_id** | Option<**String**> | Alias of adSetId, kept for existing callers. |  |
...
**start_date** | **String** | YYYY-MM-DD, in the advertiser's time zone | [required] |
**end_date** | **String** | YYYY-MM-DD, on or after startDate | [required] |
**level** | Option<**String**> | Key each row by Smart+ ad or by ad group |  |[default to ad]
**smart_plus_ad_ids** | Option<**String**> | Comma-separated Smart+ ad ids to filter by (up to 100) |  |
**ad_group_ids** | Option<**String**> | Comma-separated ad group ids to filter by (up to 100) |  |
**page** | Option<**i32**> |  |  |[default to 1]
**page_size** | Option<**i32**> |  |  |[default to 100]

### Return type

[**models::GetTikTokSmartPlusMaterialReport200Response**](getTikTokSmartPlusMaterialReport_200_response.md)
...
> models::ListLocalServicesLeadConversations200Response list_local_services_lead_conversations(lead_id, account_id, ad_account_id, customer_id, page_token)
...
> models::ListLocalServicesLeads200Response list_local_services_leads(account_id, ad_account_id, customer_id, from_date, to_date, lead_type, lead_status, charged_only, page_token)
...
**ad_account_id** | Option<**String**> | Google only: platform ad account ID (Google customer ID, digits only) when the connection has several Google Ads accounts. |  |
**customer_id** | Option<**String**> | Alias of adAccountId, kept for existing callers |  |
