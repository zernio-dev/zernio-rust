...
> models::CreateMessagingAd201Response create_call_ad(create_call_ad_request, idempotency_key)
...
> models::CreateMessagingAd201Response create_ctwa_ad(ctwa_ad_request_body, idempotency_key)
