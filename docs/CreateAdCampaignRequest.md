...
**buying_type** | Option<**BuyingType**> | Meta only. Defaults to AUCTION and is explicitly sent on new campaigns, including validateOnly. SKAdNetwork app promotion requires AUCTION. (enum: AUCTION, RESERVED) | [optional][default to Auction]
