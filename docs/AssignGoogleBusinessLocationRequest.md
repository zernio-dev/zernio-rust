...
**selected_location_id** | **String** | The Google Business Profile location ID to assign (e.g. \"locations/123\"). | 
**google_account_id** | Option<**String**> | Optional but recommended. The Google Business Profile Account resource name (\"accounts/123\") that owns the location (from GET gmb-locations). When provided the location is resolved directly instead of by enumerating the account, required for accounts with many locations.  | [optional]
