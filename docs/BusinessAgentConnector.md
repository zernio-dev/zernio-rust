...
**id** | **String** |  | 
**mcp_tool_sync** | Option<**std::collections::HashMap<String, serde_json::Value>**> |  | [optional]
**mtls_config** | Option<**std::collections::HashMap<String, serde_json::Value>**> |  | [optional]
**connection_status** | Option<[**models::BusinessAgentConnectorAllOfConnectionStatus**](BusinessAgentConnectorAllOfConnectionStatus.md)> |  | [optional]
