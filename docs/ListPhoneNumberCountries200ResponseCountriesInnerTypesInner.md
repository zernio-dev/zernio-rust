...
**whatsapp_available** | Option<**bool**> | False for toll_free (WhatsApp does not reliably register toll-free numbers) and for pairs Meta refuses, such as Chilean local (+56 2). | [optional]
