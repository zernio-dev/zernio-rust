...
/// InlineObject4Details : Structured context for SDK clients that want to render their own UX. Keys vary by `reason`.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InlineObject4Details {
    ...
    #[serde(
        rename = "verification_amount_cents",
        skip_serializing_if = "Option::is_none"
    )]
    pub verification_amount_cents: Option<i32>,
