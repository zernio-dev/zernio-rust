...
pub struct UpdateAccountSitelinksRequest {
    ...
    pub updates: Vec<models::UpdateAccountSitelinksRequestUpdatesInner>,
}

impl UpdateAccountSitelinksRequest {
    pub fn new(
        account_id: String,
        updates: Vec<models::UpdateAccountSitelinksRequestUpdatesInner>,
