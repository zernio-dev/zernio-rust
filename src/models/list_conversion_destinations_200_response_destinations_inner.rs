...
pub struct ListConversionDestinations200ResponseDestinationsInner {
    ...
    #[serde(rename = "conversionEvents", skip_serializing_if = "Option::is_none")]
    pub conversion_events: Option<
        Vec<models::ListConversionDestinations200ResponseDestinationsInnerConversionEventsInner>,
    >,
}
