...
pub struct BatchAdCatalogProductsRequestRequestsInnerProduct {
...
impl BatchAdCatalogProductsRequestRequestsInnerProduct {
    pub fn new(retailer_id: String) -> BatchAdCatalogProductsRequestRequestsInnerProduct {
