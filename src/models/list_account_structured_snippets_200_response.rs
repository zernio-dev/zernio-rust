...
pub struct ListAccountStructuredSnippets200Response {
    #[serde(rename = "customerId", skip_serializing_if = "Option::is_none")]
    pub customer_id: Option<String>,
    #[serde(rename = "structuredSnippets", skip_serializing_if = "Option::is_none")]
    pub structured_snippets:
        Option<Vec<models::ListAccountStructuredSnippets200ResponseStructuredSnippetsInner>>,
...
impl ListAccountStructuredSnippets200Response {
    pub fn new() -> ListAccountStructuredSnippets200Response {
