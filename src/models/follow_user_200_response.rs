...
pub struct FollowUser200Response {
    ...
    #[serde(rename = "pending_follow", skip_serializing_if = "Option::is_none")]
    pub pending_follow: Option<bool>,
    #[serde(rename = "platform", skip_serializing_if = "Option::is_none")]
    pub platform: Option<String>,
}

impl FollowUser200Response {
    pub fn new() -> FollowUser200Response {
