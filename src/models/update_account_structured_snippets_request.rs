...
pub struct UpdateAccountStructuredSnippetsRequest {
    ...
    pub updates: Vec<models::UpdateAccountStructuredSnippetsRequestUpdatesInner>,
}

impl UpdateAccountStructuredSnippetsRequest {
    pub fn new(
        account_id: String,
        updates: Vec<models::UpdateAccountStructuredSnippetsRequestUpdatesInner>,
