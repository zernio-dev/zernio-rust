...
pub struct GetAdNegativeKeywordList200ResponseList {
    ...
    pub keywords: Option<Vec<models::AdNegativeKeywordListKeyword>>,
}

impl GetAdNegativeKeywordList200ResponseList {
    pub fn new() -> GetAdNegativeKeywordList200ResponseList {
