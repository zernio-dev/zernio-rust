...
pub struct ListAdAccounts200ResponseAccountsInner {
    ...
    #[serde(
        rename = "fundingSourceDetails",
        skip_serializing_if = "Option::is_none"
    )]
    pub funding_source_details:
        Option<Box<models::ListAdAccounts200ResponseAccountsInnerFundingSourceDetails>>,
    ...
    #[serde(rename = "billingStatus", skip_serializing_if = "Option::is_none")]
