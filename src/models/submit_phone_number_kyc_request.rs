...
pub struct SubmitPhoneNumberKycRequest {
    ...
    pub documents: Option<Vec<models::SubmitPhoneNumberKycRequestDocumentsInner>>,
    #[serde(rename = "address", skip_serializing_if = "Option::is_none")]
    pub address: Option<Box<models::SubmitPhoneNumberKycRequestAddress>>,
}

impl SubmitPhoneNumberKycRequest {
    pub fn new(profile_id: String, country: String) -> SubmitPhoneNumberKycRequest {
