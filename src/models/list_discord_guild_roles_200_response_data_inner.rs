...
pub struct ListDiscordGuildRoles200ResponseDataInner {
    /// Role snowflake ID
...
impl ListDiscordGuildRoles200ResponseDataInner {
    pub fn new() -> ListDiscordGuildRoles200ResponseDataInner {
