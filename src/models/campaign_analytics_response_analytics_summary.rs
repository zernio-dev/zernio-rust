...
pub struct CampaignAnalyticsResponseAnalyticsSummary {
    ...
    pub search_impression_share: Option<Option<f64>>,
    /// Google only. Date-range ratio, not a percentage. Null when unavailable; Google's threshold sentinel values are preserved.
    #[serde(
    ...
    pub search_budget_lost_impression_share: Option<Option<f64>>,
    /// Google only. Date-range ratio, not a percentage. Null when unavailable; Google's threshold sentinel values are preserved.
    #[serde(
    ...
    pub search_rank_lost_impression_share: Option<Option<f64>>,
    /// Google only. Date-range ratio, not a percentage. Null when unavailable; Google's threshold sentinel values are preserved.
    #[serde(
    ...
    pub search_top_impression_share: Option<Option<f64>>,
    /// Google only. Date-range ratio, not a percentage. Null when unavailable; Google's threshold sentinel values are preserved.
    #[serde(
    ...
    pub search_absolute_top_impression_share: Option<Option<f64>>,
}

impl CampaignAnalyticsResponseAnalyticsSummary {
    pub fn new() -> CampaignAnalyticsResponseAnalyticsSummary {
