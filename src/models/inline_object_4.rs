...
pub struct InlineObject4 {
    ...
    pub details: Option<Box<models::InlineObject4Details>>,
}

impl InlineObject4 {
    pub fn new(error: String, code: Code, reason: Reason) -> InlineObject4 {
        InlineObject4 {
            error,
            code,
            reason,
...
pub enum Reason {
    ...
    EnterpriseRequired,
    #[serde(rename = "card_verification_required")]
