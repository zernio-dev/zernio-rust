...
pub struct ListAdNegativeKeywordLists200Response {
    #[serde(rename = "lists", skip_serializing_if = "Option::is_none")]
    pub lists: Option<Vec<models::AdNegativeKeywordList>>,
...
impl ListAdNegativeKeywordLists200Response {
    pub fn new() -> ListAdNegativeKeywordLists200Response {
