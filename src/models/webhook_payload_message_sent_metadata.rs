...
pub struct WebhookPayloadMessageSentMetadata {
    ...
    #[serde(rename = "metaInteractive", skip_serializing_if = "Option::is_none")]
    pub meta_interactive: Option<std::collections::HashMap<String, serde_json::Value>>,
