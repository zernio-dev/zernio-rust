...
pub struct CreateStandaloneAdRequestCitiesInnerOneOf {
...
impl CreateStandaloneAdRequestCitiesInnerOneOf {
    pub fn new(key: String) -> CreateStandaloneAdRequestCitiesInnerOneOf {
