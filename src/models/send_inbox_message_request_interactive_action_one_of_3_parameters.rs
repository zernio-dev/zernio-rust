...
pub struct SendInboxMessageRequestInteractiveActionOneOf3Parameters {
    ...
    pub flow_action_payload: Option<
        Box<models::SendInboxMessageRequestInteractiveActionOneOf3ParametersFlowActionPayload>,
    >,
...
impl SendInboxMessageRequestInteractiveActionOneOf3Parameters {
    pub fn new(
        flow_token: String,
        flow_id: String,
        flow_cta: String,
