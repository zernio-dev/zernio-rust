...
/// InlineObject3Details : Structured context for SDK clients that want to render their own UX. Keys vary by `reason`.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InlineObject3Details {
