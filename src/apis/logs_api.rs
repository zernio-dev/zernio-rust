...
pub async fn list_logs(
    ...
    account_id2: Option<&str>,
    event: Option<&str>,
    request_id: Option<&str>,
    request_id2: Option<&str>,
    from: Option<String>,
    to: Option<String>,
    status_code: Option<i32>,
    status_code2: Option<i32>,
    api_key_id: Option<&str>,
    api_key_id2: Option<&str>,
    include_read_receipts: Option<bool>,
    include_read_receipts2: Option<bool>,
