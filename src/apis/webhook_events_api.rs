...
/// struct for typed errors of method [`on_sms_registration_action_required`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OnSmsRegistrationActionRequiredError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`on_sms_registration_status_updated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OnSmsRegistrationStatusUpdatedError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`on_whats_app_template_category_updated`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum OnWhatsAppTemplateCategoryUpdatedError {
    UnknownValue(serde_json::Value),
}
...
pub async fn on_sms_registration_action_required(configuration: &configuration::Configuration, on_sms_registration_action_required_request: models::OnSmsRegistrationActionRequiredRequest) -> Result<(), Error<OnSmsRegistrationActionRequiredError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_on_sms_registration_action_required_request = on_sms_registration_action_required_request;

    let uri_str = format!("{}/sms.registration.action_required", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_on_sms_registration_action_required_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OnSmsRegistrationActionRequiredError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn on_sms_registration_status_updated(configuration: &configuration::Configuration, on_sms_registration_status_updated_request: models::OnSmsRegistrationStatusUpdatedRequest) -> Result<(), Error<OnSmsRegistrationStatusUpdatedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_on_sms_registration_status_updated_request = on_sms_registration_status_updated_request;

    let uri_str = format!("{}/sms.registration.status_updated", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_on_sms_registration_status_updated_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OnSmsRegistrationStatusUpdatedError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn on_whats_app_template_category_updated(configuration: &configuration::Configuration, webhook_payload_whats_app_template_category_updated: models::WebhookPayloadWhatsAppTemplateCategoryUpdated) -> Result<(), Error<OnWhatsAppTemplateCategoryUpdatedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_webhook_payload_whats_app_template_category_updated = webhook_payload_whats_app_template_category_updated;

    let uri_str = format!("{}/whatsapp.template.category_updated", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_webhook_payload_whats_app_template_category_updated);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OnWhatsAppTemplateCategoryUpdatedError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
