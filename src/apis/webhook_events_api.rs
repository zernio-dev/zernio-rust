...
pub async fn on_lead_received(configuration: &configuration::Configuration, webhook_payload_lead_received: models::WebhookPayloadLeadReceived) -> Result<(), Error<OnLeadReceivedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_webhook_payload_lead_received = webhook_payload_lead_received;
    ...
    req_builder = req_builder.json(&p_body_webhook_payload_lead_received);
