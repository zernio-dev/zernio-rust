...
/// struct for typed errors of method [`block_whats_app_users`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`get_whats_app_blocked_users`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`get_whats_app_commerce_settings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetWhatsAppCommerceSettingsError {
    Status400(models::ErrorResponse),
    Status401(models::InlineObject1),
...
/// struct for typed errors of method [`link_whats_app_catalog`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LinkWhatsAppCatalogError {
    Status400(models::ErrorResponse),
    Status401(models::InlineObject1),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`list_whats_app_account_events`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`list_whats_app_catalogs`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListWhatsAppCatalogsError {
    Status400(models::ErrorResponse),
    Status401(models::InlineObject1),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`unblock_whats_app_users`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`unlink_whats_app_catalog`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UnlinkWhatsAppCatalogError {
    Status400(models::ErrorResponse),
    Status401(models::InlineObject1),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
/// struct for typed errors of method [`update_whats_app_commerce_settings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateWhatsAppCommerceSettingsError {
    Status400(models::ErrorResponse),
    Status401(models::InlineObject1),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
...
pub async fn block_whats_app_users(
    configuration: &configuration::Configuration,
    block_whats_app_users_request: models::BlockWhatsAppUsersRequest,
) -> Result<models::BlockWhatsAppUsers200Response, Error<BlockWhatsAppUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_block_whats_app_users_request = block_whats_app_users_request;

    let uri_str = format!("{}/v1/whatsapp/block-users", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_block_whats_app_users_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::BlockWhatsAppUsers200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::BlockWhatsAppUsers200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<BlockWhatsAppUsersError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_whats_app_block_status(
    configuration: &configuration::Configuration,
    account_id: &str,
    user: &str,
) -> Result<models::GetWhatsAppBlockStatus200Response, Error<GetWhatsAppBlockStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_account_id = account_id;
    let p_query_user = user;

    let uri_str = format!("{}/v1/whatsapp/block-users/status", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetWhatsAppBlockStatus200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetWhatsAppBlockStatus200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetWhatsAppBlockStatusError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_whats_app_blocked_users(
    configuration: &configuration::Configuration,
    account_id: &str,
    limit: Option<i32>,
    after: Option<&str>,
) -> Result<models::GetWhatsAppBlockedUsers200Response, Error<GetWhatsAppBlockedUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetWhatsAppBlockedUsers200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetWhatsAppBlockedUsers200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetWhatsAppBlockedUsersError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_whats_app_commerce_settings(
    configuration: &configuration::Configuration,
    account_id: &str,
    catalog_account_id: Option<&str>,
) -> Result<models::GetWhatsAppCommerceSettings200Response, Error<GetWhatsAppCommerceSettingsError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_account_id = account_id;
    let p_query_catalog_account_id = catalog_account_id;

    let uri_str = format!("{}/v1/whatsapp/commerce-settings", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetWhatsAppCommerceSettings200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetWhatsAppCommerceSettings200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetWhatsAppCommerceSettingsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn link_whats_app_catalog(
    configuration: &configuration::Configuration,
    link_whats_app_catalog_request: models::LinkWhatsAppCatalogRequest,
) -> Result<models::ListWhatsAppCatalogs200Response, Error<LinkWhatsAppCatalogError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_link_whats_app_catalog_request = link_whats_app_catalog_request;

    let uri_str = format!("{}/v1/whatsapp/catalogs", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_link_whats_app_catalog_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListWhatsAppCatalogs200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListWhatsAppCatalogs200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<LinkWhatsAppCatalogError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_whats_app_account_events(
    configuration: &configuration::Configuration,
    account_id: &str,
    limit: Option<i32>,
) -> Result<models::ListWhatsAppAccountEvents200Response, Error<ListWhatsAppAccountEventsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_account_id = account_id;
    let p_query_limit = limit;

    let uri_str = format!("{}/v1/whatsapp/account-events", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListWhatsAppAccountEvents200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListWhatsAppAccountEvents200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListWhatsAppAccountEventsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_whats_app_catalogs(
    configuration: &configuration::Configuration,
    account_id: &str,
    catalog_account_id: Option<&str>,
) -> Result<models::ListWhatsAppCatalogs200Response, Error<ListWhatsAppCatalogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_account_id = account_id;
    let p_query_catalog_account_id = catalog_account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ListWhatsAppCatalogsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn unblock_whats_app_users(
    configuration: &configuration::Configuration,
    unblock_whats_app_users_request: models::UnblockWhatsAppUsersRequest,
) -> Result<models::UnblockWhatsAppUsers200Response, Error<UnblockWhatsAppUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_unblock_whats_app_users_request = unblock_whats_app_users_request;
    ...
    req_builder = req_builder.json(&p_body_unblock_whats_app_users_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UnblockWhatsAppUsers200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UnblockWhatsAppUsers200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<UnblockWhatsAppUsersError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn unlink_whats_app_catalog(
    configuration: &configuration::Configuration,
    account_id: &str,
    catalog_id: &str,
    catalog_account_id: Option<&str>,
) -> Result<models::UnlinkWhatsAppCatalog200Response, Error<UnlinkWhatsAppCatalogError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_account_id = account_id;
    ...
    req_builder = req_builder.query(&[("catalogId", &p_query_catalog_id.to_string())]);
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    if let Some(ref token) = configuration.bearer_access_token {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UnlinkWhatsAppCatalog200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UnlinkWhatsAppCatalog200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<UnlinkWhatsAppCatalogError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn update_whats_app_commerce_settings(
    configuration: &configuration::Configuration,
    update_whats_app_commerce_settings_request: models::UpdateWhatsAppCommerceSettingsRequest,
) -> Result<
    models::GetWhatsAppCommerceSettings200Response,
    Error<UpdateWhatsAppCommerceSettingsError>,
> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_update_whats_app_commerce_settings_request =
        update_whats_app_commerce_settings_request;
    ...
    req_builder = req_builder.json(&p_body_update_whats_app_commerce_settings_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateWhatsAppCommerceSettingsError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
