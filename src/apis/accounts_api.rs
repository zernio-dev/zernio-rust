...
/// struct for typed errors of method [`get_instagram_follow_status`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`get_slack_settings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`list_tik_tok_commercial_music`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListTikTokCommercialMusicError {
    Status400(models::ErrorResponse),
    Status404(),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`move_account_to_profile`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`search_tik_tok_locations`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchTikTokLocationsError {
    Status400(models::ErrorResponse),
    Status404(),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`update_slack_settings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn get_instagram_follow_status(
    configuration: &configuration::Configuration,
    account_id: &str,
    user_id: &str,
    refresh: Option<bool>,
) -> Result<models::GetInstagramFollowStatus200Response, Error<GetInstagramFollowStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetInstagramFollowStatus200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetInstagramFollowStatus200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetInstagramFollowStatusError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_slack_settings(
    configuration: &configuration::Configuration,
    account_id: &str,
) -> Result<models::GetSlackSettings200Response, Error<GetSlackSettingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetSlackSettings200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetSlackSettings200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetSlackSettingsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_tik_tok_commercial_music(
    configuration: &configuration::Configuration,
    account_id: &str,
    country_code: Option<&str>,
) -> Result<models::ListTikTokCommercialMusic200Response, Error<ListTikTokCommercialMusicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListTikTokCommercialMusic200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListTikTokCommercialMusic200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListTikTokCommercialMusicError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn move_account_to_profile(
    configuration: &configuration::Configuration,
    account_id: &str,
    move_account_to_profile_request: models::MoveAccountToProfileRequest,
) -> Result<models::MoveAccountToProfile200Response, Error<MoveAccountToProfileError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    let p_body_move_account_to_profile_request = move_account_to_profile_request;
    ...
    req_builder = req_builder.json(&p_body_move_account_to_profile_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::MoveAccountToProfile200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::MoveAccountToProfile200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<MoveAccountToProfileError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn search_tik_tok_locations(
    configuration: &configuration::Configuration,
    account_id: &str,
    query: &str,
) -> Result<models::SearchTikTokLocations200Response, Error<SearchTikTokLocationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::SearchTikTokLocations200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::SearchTikTokLocations200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<SearchTikTokLocationsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn update_slack_settings(
    configuration: &configuration::Configuration,
    account_id: &str,
    update_slack_settings_request: models::UpdateSlackSettingsRequest,
) -> Result<(), Error<UpdateSlackSettingsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_id = account_id;
    let p_body_update_slack_settings_request = update_slack_settings_request;
    ...
    req_builder = req_builder.json(&p_body_update_slack_settings_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateSlackSettingsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
