...
/// struct for typed errors of method [`create_phone_number_stock_watch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`delete_phone_number_stock_watch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`get_phone_number_claim`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetPhoneNumberClaimError {
    Status400(models::ErrorResponse),
    Status401(models::InlineObject1),
    Status404(),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`get_phone_number_port_claim`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetPhoneNumberPortClaimError {
    Status400(models::ErrorResponse),
    Status401(models::InlineObject1),
    Status404(),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`list_phone_number_stock_watches`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub enum PurchasePhoneNumberError {
    Status400(),
    Status401(models::PurchasePhoneNumber401Response),
    Status402(),
    Status403(),
...
pub async fn create_phone_number_stock_watch(
    configuration: &configuration::Configuration,
    create_phone_number_stock_watch_request: models::CreatePhoneNumberStockWatchRequest,
) -> Result<models::PhoneNumberStockWatch, Error<CreatePhoneNumberStockWatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_create_phone_number_stock_watch_request = create_phone_number_stock_watch_request;

    let uri_str = format!("{}/v1/phone-numbers/stock-watches", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_body_create_phone_number_stock_watch_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PhoneNumberStockWatch`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PhoneNumberStockWatch`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreatePhoneNumberStockWatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn delete_phone_number_stock_watch(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::DeleteSmsSenderId200Response, Error<DeletePhoneNumberStockWatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeletePhoneNumberStockWatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_phone_number_claim(
    configuration: &configuration::Configuration,
    claim_id: &str,
) -> Result<models::GetPhoneNumberClaim200Response, Error<GetPhoneNumberClaimError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_claim_id = claim_id;

    let uri_str = format!(
        "{}/v1/phone-numbers/claims/{claimId}",
        configuration.base_path,
        claimId = crate::apis::urlencode(p_path_claim_id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetPhoneNumberClaim200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetPhoneNumberClaim200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetPhoneNumberClaimError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_phone_number_port_claim(
    configuration: &configuration::Configuration,
    claim_id: &str,
) -> Result<models::GetPhoneNumberPortClaim200Response, Error<GetPhoneNumberPortClaimError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_claim_id = claim_id;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetPhoneNumberPortClaim200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetPhoneNumberPortClaim200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetPhoneNumberPortClaimError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_phone_number_stock_watches(
    configuration: &configuration::Configuration,
) -> Result<models::ListPhoneNumberStockWatches200Response, Error<ListPhoneNumberStockWatchesError>>
{
    let uri_str = format!("{}/v1/phone-numbers/stock-watches", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ListPhoneNumberStockWatches200Response`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ListPhoneNumberStockWatches200Response`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListPhoneNumberStockWatchesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
) -> Result<models::SearchAvailablePhoneNumbers200Response, Error<SearchAvailablePhoneNumbersError>>
{
    ...
    let p_query_country = country;
    let p_query_number_type = number_type;
    let p_query_area_code = area_code;
    ...
    if let Some(ref param_value) = p_query_area_code {
    ...
    if let Some(ref param_value) = p_query_masked {
        req_builder = req_builder.query(&[("masked", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
